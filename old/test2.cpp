...
static constexpr std::array<const char*, 4> assetPaths = {
		"C:/CTools/Projects/mglw-strip/assets/shaders/compute_rtrace/shader.vert",
		"C:/CTools/Projects/mglw-strip/assets/shaders/compute_rtrace/shader.frag",
		"C:/CTools/Projects/mglw-strip/assets/shaders/compute_rtrace/shader.comp",
...
int main(__unused int argc, __unused char* argv[])
{
	...
	// -------------------------
    static const std::vector< std::pair<u32, const char*> > shaderInfo = {
		{ GL_VERTEX_SHADER,   assetPaths[0] },
		{ GL_FRAGMENT_SHADER, assetPaths[1] },
		{ GL_COMPUTE_SHADER , assetPaths[2] }
	};
    u32 screenQuad, computeShader;
    screenQuad    = reloadShaders({ shaderInfo[0], shaderInfo[1] });
    computeShader = reloadShaders({ shaderInfo[2] });

    glProgramUniform1i(screenQuad, glGetUniformLocation(screenQuad, "tex"), 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDispatchCompute((unsigned int)TEXTURE_WIDTH/10, (unsigned int)TEXTURE_HEIGHT, 1);
